...
import { Home, Radio, Sparkles, FolderTree, Settings, Logs, FlaskConical, Key } from 'lucide-react';
...
const TestModel_Module = lazyWithPreload(() => import('@/components/modules/testmodel').then(m => ({ default: m.TestModel })));
const OAuthProvider_Module = lazyWithPreload(() => import('@/components/modules/oauth-provider').then(m => ({ default: m.OAuthProvider })));
...
export const ROUTES: RouteConfig[] = [
    ...
    { id: 'testmodel', label: 'TestModel', icon: FlaskConical, component: TestModel_Module },
