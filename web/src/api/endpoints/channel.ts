...
export function useChannelListRegular() {
  return useQuery({
    ...
    queryFn: async () => {
      return apiClient.get<ChannelServer[]>(
        "/api/v1/channel/list?use_oauth=false",
      );
    },
